...
| Version | Supported |
| :--- | :---: |
| 2.x (FUSE Engine) | ✅ Supported |
| 1.x (Legacy) | ❌ End of Life |
...
2. Step-by-step proof of concept or instructions to reproduce the issue safely.
3. Affected components, modules, or configurations.

### Response Commitment
- Reports will be acknowledged within 48 hours.
- A remediation patch will be prepared, verified, and released promptly upon confirmation.
