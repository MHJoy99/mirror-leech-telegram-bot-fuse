...
async def check_drive_duplicate(listener, destination):
    if not destination or not is_gdrive_id(destination):
        return False, None
...
async def stop_duplicate_check(listener):
    ...
    return await check_drive_duplicate(listener, listener.up_dest)
